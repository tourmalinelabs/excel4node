...
var Worksheet = function () {
    ...
    _createClass(Worksheet, [{
        ...
        get: function get() {
            ...
            try {
                for (var _iterator = Object.keys(this.cols)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var v = _step.value;
        ...
        get: function get() {
            ...
            try {
                for (var _iterator2 = Object.keys(this.rows)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var v = _step2.value;
